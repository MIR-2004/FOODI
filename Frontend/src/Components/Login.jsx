...
import { Mail, Lock, Eye, EyeOff, ArrowLeft, ShieldCheck, Sparkles, TrendingUp, Users, ChefHat } from "lucide-react";
...
const showcaseData = [
  {
    ...
    title: "Savor the Art of Culinary Mastery",
    subtitle: "Unlock elite restaurant cataloging, POS terminals synchronization, and real-time Stripe earnings tracking in one high-end dashboard.",
    badge: "Chef's Premium Platform"
  },
  {
    image: "/images/home/category/img1.png",
    title: "Sleek Inventory & Menu Control",
    subtitle: "Manage your premium dishes, set dynamic prices, and catalog delicious culinary choices effortlessly in real-time.",
    badge: "Gourmet Menu Sync"
  },
  {
    image: "/images/home/category/img2.png",
    title: "Secured Stripe Transactions",
    subtitle: "Process checkout payments with enterprise-grade encryption and receive real-time analytics alerts.",
    badge: "Automated Stripe Settlements"
  },
  {
    image: "/images/home/category/img3.png",
    title: "Advanced SaaS Merchant Dashboard",
    subtitle: "Gain deep business intelligence insights about customers, order pipelines, and monthly recurring revenue performance.",
    badge: "Merchant Analytics Suite"
  }
];
    ...
    signUpWithGmail()
      .then((result) => {
        ...
        axiosPublic
          ...
          .catch(() => {
            // Even if server returns 302/user already exists, log them in
        ...
        <div className="max-w-md w-full space-y-8 glass-card rounded-[2.5rem] p-8 md:p-10 border border-slate-800/80 relative z-10 shadow-2xl transition-all duration-500">
          ...
          <form className="mt-8 space-y-5" onSubmit={handleSubmit(onSubmit)}>
            <div className="space-y-4">
              ...
              <div className="form-control">
                <div className="flex justify-between items-center mb-1.5">
                  ...
                  <a href="#" className="text-xs font-semibold text-slate-400 hover:text-green transition duration-200">
                    Forgot password?
                  </a>
                </div>
                <div className="relative">
            ...
            <p className="text-center text-sm text-slate-450">
              ...
              <Link to="/signup" className="font-semibold text-green hover:text-emerald-450 hover:underline ml-1.5 transition">
                Create Account
              </Link>
            </p>
          </form>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-[#121926]/90 px-3 text-slate-500 rounded-md font-semibold">Or secure login with</span>
            </div>
          </div>
